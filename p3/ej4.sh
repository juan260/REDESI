...
# que recibe como segundo argumento. Los resultados los exporta en dos graficas con nombres
...
./grafica.sh "Ancho de banda de salida en cada segundo" "Ancho (bits/seg)" "Segundo" "datostasa.tmp" "graficaTasaDeEntrada.jpeg"
