/***************************************************************************
 practica2.c
 Ejercicio único de la práctica 2 de Redes I
...
int main(int argc, char **argv){
	...
	//Simple lectura por parametros por completar casos de error, ojo cumple 100% los requisitos del enunciado!
	...
	if(ipsrc_filter[0]!=0 || ipdst_filter[0]!=0)
	    printf("Filtro:");
	if(ipsrc_filter[0]!=0)
